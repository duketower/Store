    ...
    <PageContainer title="Firestore Migration" subtitle="One-time sync: local data → Firestore">
      <div className="max-w-md space-y-5">
        <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800">
          ...
          <p>Copies products, batches, customers, employees, expenses, vendors, and GRNs from IndexedDB to Firestore. Safe to re-run — existing records are overwritten with current values.</p>
        </div>
