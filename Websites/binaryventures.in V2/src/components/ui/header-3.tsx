    ...
    >
      <nav className="mx-auto flex h-14 w-full max-w-5xl items-center justify-between px-4">
        <div className="flex items-center gap-5">
          <a href="#" className="rounded-md p-2 hover:bg-accent" aria-label="Home">
            ...
            <NavigationMenuList>
              ...
              <NavigationMenuItem>
                <NavigationMenuLink className="px-4" asChild>
                  <a href="#" className="rounded-md p-2 hover:bg-accent">
                    Pricing
                  </a>
                </NavigationMenuLink>
              </NavigationMenuItem>
...
function MobileMenu({ open, children, className, ...props }: MobileMenuProps) {
  ...
  return createPortal(
    <div
      id="mobile-menu"
      className={cn(
        "bg-background/95 fixed top-14 right-0 bottom-0 left-0 z-40 flex flex-col overflow-hidden border-y backdrop-blur-lg supports-[backdrop-filter]:bg-background/50 md:hidden"
      )}
    >
      <div
        data-slot={open ? "open" : "closed"}
        className={cn(
          "data-[slot=open]:animate-in data-[slot=open]:zoom-in-97 size-full p-4 ease-out",
          className
        )}
        {...props}
      >
